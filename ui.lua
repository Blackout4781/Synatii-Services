...
local Themes = {
	...
	Dark = {
		MainFrame = Color3.fromRGB(105,105,105),
		Minimise = Color3.fromRGB(255, 87, 51.),
		MinimiseAccent = Color3.fromRGB(105,105,105),
		Maximise = Color3.fromRGB(105,105,105),
		MaximiseAccent = Color3.fromRGB(105,105,105),
		NavBar = Color3.fromRGB(105,105,105),
		NavBarAccent = Color3.fromRGB(105,105,105),
		NavBarInvert = Color3.fromRGB(105,105,105),
		TitleBar = Color3.fromRGB(105,105,105),
		TitleBarAccent = Color3.fromRGB(105,105,105),
		Overlay = Color3.fromRGB(105,105,105),
		Banner = Color3.fromRGB(105,105,105),
		BannerAccent = Color3.fromRGB(105,105,105),
		Content = Color3.fromRGB(105,105,105),
		Button = Color3.fromRGB(105,105,105),
		ButtonAccent = Color3.fromRGB(105,105,105),
		ChipSet = Color3.fromRGB(105,105,105),
		ChipSetAccent = Color3.fromRGB(105,105,105),
		DataTable = Color3.fromRGB(105,105,105),
		DataTableAccent = Color3.fromRGB(105,105,105),
		Slider = Color3.fromRGB(105,105,105),
		SliderAccent = Color3.fromRGB(105,105,105),
		Toggle = Color3.fromRGB(105,105,105),
		ToggleAccent = Color3.fromRGB(105,105,105),
		Dropdown = Color3.fromRGB(105,105,105),
		DropdownAccent = Color3.fromRGB(105,105,105),
		ColorPicker = Color3.fromRGB(85,85,85),
		ColorPickerAccent = Color3.fromRGB(105,105,105),
		TextField = Color3.fromRGB(105,105,105),
		TextFieldAccent = Color3.fromRGB(105,105,105),
	},
	Mocha = {
		MainFrame = Color3.fromRGB(255,255,255),
